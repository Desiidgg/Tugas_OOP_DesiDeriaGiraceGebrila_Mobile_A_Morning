...
fun myProfile() {
    ...
    val firstName: String = "Desi"
    val lastName: String = "Gebrila"
    val age: Int = 20
 ...
 */
fun myTeam(): List<Any> {
    val teamMembers = listOf("Adit", "Ahmad", "Elfan", "Desi", "Ray")
 ...
 */
fun totalMember(): Int {
    val mentorName = arrayOf("Kak Pupu", "Kak Lia", "Kak Reza")
    val countOfTeam = arrayOf("Adit", "Ahmad", "Elfan", "Desi", "Ray")

    return mentorName.size + countOfTeam.size
}
